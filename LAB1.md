...
Ler cap. 1 e 3 do livro do dragão.
...
**Fase 1 de Compiladores (Análise Léxica / Scanner)**: Capítulos 1 e 3 do Livro do Dragão 
...
- Ler **Capítulo 3 completo** do Livro do Dragão Lexical Analysis
- PC desktop ou notebook com Linux Ubuntu/Debian (recomendado), ou VM Ubuntu + internet, ou no Windows 10 ou 11 no WSL2.
...
3. Criar NFA (Non-Deterministic Finite Automata - Pode seguir mais de um fluxo) para operador `=` e `==` (ambiguidade).
